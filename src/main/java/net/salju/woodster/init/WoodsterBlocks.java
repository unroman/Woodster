...
public class WoodsterBlocks {
	...
	public static final BlockBehaviour.Properties CHISELED_NETHER_BOOKSHELF = BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(1.5F).sound(SoundType.CHISELED_BOOKSHELF);
	...
	public static final RegistryObject<Block> OAK_CHISELED_BOOKSHELF = REGISTRY.register("oak_chiseled_bookshelf", () -> new ChiseledBookshelfBlock(WoodsterBlocks.CHISELED_BOOKSHELF));
	...
	public static final RegistryObject<Block> CRIMSON_CHISELED_BOOKSHELF = REGISTRY.register("crimson_chiseled_bookshelf", () -> new ChiseledBookshelfBlock(WoodsterBlocks.CHISELED_NETHER_BOOKSHELF));
	public static final RegistryObject<Block> WARPED_CHISELED_BOOKSHELF = REGISTRY.register("warped_chiseled_bookshelf", () -> new ChiseledBookshelfBlock(WoodsterBlocks.CHISELED_NETHER_BOOKSHELF));
