...
public class WoodsterBlocks {
	...
	public static final BlockBehaviour.Properties CHISELED_BOOKSHELF = BlockBehaviour.Properties.of(Material.WOOD).strength(1.5F).sound(SoundType.CHISELED_BOOKSHELF);
	...
	public static final RegistryObject<Block> CRIMSON_CHISELED_BOOKSHELF = REGISTRY.register("crimson_chiseled_bookshelf", () -> new ChiseledBookshelfBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(1.5F).sound(SoundType.CHISELED_BOOKSHELF)));
	public static final RegistryObject<Block> WARPED_CHISELED_BOOKSHELF = REGISTRY.register("warped_chiseled_bookshelf", () -> new ChiseledBookshelfBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(1.5F).sound(SoundType.CHISELED_BOOKSHELF)));
	...
	public static final RegistryObject<Block> CHERRY_BOOKSHELF = REGISTRY.register("cherry_bookshelf", () -> new BookshelfBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(1.5F).sound(SoundType.CHERRY_WOOD)));
	public static final RegistryObject<Block> BAMBOO_BOOKSHELF = REGISTRY.register("bamboo_bookshelf", () -> new BookshelfBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(1.5F).sound(SoundType.BAMBOO_WOOD)));
	public static final RegistryObject<Block> CRIMSON_BOOKSHELF = REGISTRY.register("crimson_bookshelf", () -> new BookshelfBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(1.5F).sound(SoundType.NETHER_WOOD)));
	public static final RegistryObject<Block> WARPED_BOOKSHELF = REGISTRY.register("warped_bookshelf", () -> new BookshelfBlock(BlockBehaviour.Properties.of(Material.NETHER_WOOD).strength(1.5F).sound(SoundType.NETHER_WOOD)));
