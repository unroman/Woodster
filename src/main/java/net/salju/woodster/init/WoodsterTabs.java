...
public class WoodsterTabs {
	...
	public static void buildTabContentsModded(CreativeModeTabEvent.Register event) {
		event.registerCreativeModeTab(new ResourceLocation("woodster"), builder -> builder.title(Component.translatable("itemGroup.woodster")).icon(() -> new ItemStack(Blocks.CHISELED_BOOKSHELF.asItem())).displayItems((parameters, tabData) -> {
